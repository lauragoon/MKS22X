public class ExpressionTree{
  ...
  private double perform(char op, double left, double right) {
    double ret = 0.0;
    switch (op) {
      case '+':
        ret = left + right;
  ...
  public String toStringPostfix(){
    ...
    if (isValue()) {
      ...
      ret += getLeft().toStringPostfix() + " " + getRight().toStringPostfix() + " " + getOp();
    }
    return ret;
  }
  ...
  public String toStringPrefix(){
    ...
    if (isValue()) {
      ...
      ret += getOp() + " " + getLeft().toStringPrefix() + " " + getRight().toStringPrefix();
    }
    return ret;
  }
